...
import { BAG, S } from '../../src/game/state.js';
import { theme, rrect } from '../../src/art/helpers.js';
...
export function paintBody(frameOnly) {
...
export function drawEmptyLabel() {
...
/** Khung túi để sinh sprite: viền quanh lòng túi + viền ngoài + trang trí, KHÔNG có block và mép lòng túi */
