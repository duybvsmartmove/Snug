...
/** Nhóm va chạm của trần vô hình ngoài màn (mặc định của Matter là 1): đồ mưa từ trên đỉnh màn
 *  lúc mở màn xuyên qua trần này, còn túi và vật cản thì va như thật. */
export const NHOM_TRAN = 0x0002;
